...
// ANSWER: 
function 1 made a new object but it is constant so it is 1. The foeach loop will need 0(n) space so it is 0(n)
function2 doesn't create additional object but it has a for loop as weel, which take 0(n) space. so it is also 0(n) space.
